...
\begin{figure}[H]
\includegraphics[scale=0.3]{app_homescreen}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.3]{app_angle}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.5]{phone_placement}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.3]{app_menu_compass}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.3]{app_compass}
\centering
\caption{Opción brújula del menú}
\end{figure}
